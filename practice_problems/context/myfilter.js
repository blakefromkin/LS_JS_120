// update an implementation of myFilter by adding the functionality of accepting an optional thisArg just like the original Array.prototype.filter.
...
function myFilter(array, func, thisArg) {
  ...
  array.forEach(function(value) {
    if (func.call(thisArg, value)) { // Answer <=
      result.push(value);
    }
  });
